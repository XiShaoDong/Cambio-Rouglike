...
> **本文档职责**：游戏**规则、产品、架构的权威主规格**（含冻结规则 R-01~R-10）。开发/实现细节见 `功能实现文档.md` 与 `AI_AGENT_交接说明.md`；协议契约见 `网络协议_V1.md`。改动规则前必须先更新本文档。
...
**规则变更流程：**任何影响 R-01 至 R-10 的修改，必须先新增决策 ID、说明旧/新裁定、补测试项，再调整实现；不能以 UI 方便或局部 bug 为理由静默修改规则。
